...
>
  {/* Players behind */}
  {topTeam && topTeam.players.map((player, index) => (
    <div
      key={player._id}
...
<div className="absolute right-0 top-[250px] bottom-0 w-[400px] ">
  ...
  {remainingTeams.map((team, index) => (
    <div key={team._id} className="w-full relative flex items-center text-black font-bold border-b-[#000000] border-b-[1px] overflow-visible " style={{ height: `${baseRowHeight}px` }}>
      {/* Rank box */}
      <div
