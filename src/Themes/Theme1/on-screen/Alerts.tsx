  ...
  useEffect(() => {
    ...
    const alertsHandlers = {
      handleLiveUpdate: (data: any) => {
        console.log('Alerts: Received liveMatchUpdate for match:', data.matchId);
      ...
      handleMatchDataUpdate: (data: any) => {
        ...
        if (data.matchDataId === matchDataId) {
          ...
          setLocalMatchData((prev: MatchData | null) => {
            ...
            if (updatedTeam && updatedTeam.players.every((p: Player) => p.bHasDied)) {
      ...
      <svg width="1920" height="1080" viewBox="0 0 1920 1080" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {alertTeam && (
          ...
          >
            ...
            <tspan dx="10">{sortedTeams.findIndex(t => t._id === alertTeam._id) + 1}</tspan>
